...
const coffeeOptions = [
  {
    ...
    tag: "Blended Coffee",
    icon: "\ud83c\udf0d",
    image: "https://res.cloudinary.com/pactcoffee/image/upload/f_auto,q_auto/website-b2b/UploadedCMS/2022/Group_1187.png",
  },
  {
...
export default function CoffeeSelection() {
  ...
  return (
    <div className="pb-12  text-center">
              <ProgressBar step={4} />
      <h2 className="text-3xl font-bold text-gray-900 mt-10">Choose Your Espresso Coffee</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10 max-w-7xl mx-auto">
        {coffeeOptions.map((coffee, index) => (
          <div
            key={index}
            className="bg-teal-900 text-white p-6 rounded-lg shadow-md relative flex flex-col items-center"
          >
            ...
            <button   onClick={handleNextClick}  className="mt-6 w-full bg-orange-500 text-white text-lg font-bold py-3 rounded-md hover:bg-orange-600 transition">
              CHOOSE PLAN &gt;
            </button>
          </div>
        ))}
