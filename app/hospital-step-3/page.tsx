...
function RegionSelectionContent() {
	// State management
				...
				<div className='mb-6'>
					...
					<div className='relative'>
						<input
							...
							disabled={isLoading}
						/>
						{region && !error && <span className='absolute right-2 top-2 text-green-500 transition-opacity'>✓</span>}
					</div>
					{error && touched && <p className='text-red-500 text-sm mt-1 transition-opacity'>{error}</p>}
				</div>
