...
const CoffeeSelector = () => {
  ...
  const calculateBackground = () => {
    ...
    return `linear-gradient(to right, #1D4045 ${percentage}%, #E5E7EB ${percentage}%)`;
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <h1 className="text-xl md:text-2xl lg:text-3xl font-semibold text-[#1D4045] text-center">
        ...
        <div className="bg-white rounded-lg p-6">
          ...
          <div className="flex items-start space-x-4 mb-8">
            <div className="w-12 h-12 flex-shrink-0 bg-gray-50 rounded-lg flex items-center justify-center">
              <svg className="w-6 h-6 text-[#1D4045]" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
              </svg>
            </div>
            <div className="flex-grow">
              <p className="text-[#1D4045] text-lg font-medium mb-1">For an office with</p>
              <p className="text-[#1D4045] text-lg font-medium">
          ...
          {/* Recommendation Box */}
          <div className="bg-[#1D4045] rounded-xl p-6 mb-6">
          ...
          <button
            ...
            className="w-full bg-[#1D4045] text-white py-4 rounded-lg font-medium text-lg hover:bg-[#162c30] transition-colors"
          >
            Next
          </button>
        </div>
